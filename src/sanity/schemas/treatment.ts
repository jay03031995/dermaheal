...
export const treatmentSchema = defineType({
  ...
  fields: [
    ...
    defineField({
      name: "overviewExtra",
      title: "About section supporting copy",
      type: "text",
      rows: 4,
      group: "detail",
      description: "Shown in the 'About the treatment' section beneath the overview. Leave empty to use the default dermatologist note.",
    }),
    defineField({
      name: "aboutCtaLabel",
      title: "About section CTA label",
      type: "string",
      group: "detail",
      description: "Button text in the 'About the treatment' section. Leave empty to use the default 'Speak to a dermatologist'.",
    }),
    defineField({
      name: "aboutCtaHref",
      title: "About section CTA link",
      type: "string",
      group: "detail",
      description: "Link target for the button in the 'About the treatment' section. Leave empty to use the default booking section anchor.",
    }),
