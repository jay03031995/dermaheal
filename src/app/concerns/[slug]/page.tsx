...
import { CONCERN_SLUGS, getConcern } from "@/data/concerns";
import { TREATMENTS_FULL } from "@/data/treatments";
...
export default async function ConcernDetailPage(props: {
  ...
  const treatments = c.treatmentSlugs
    .map((s) => TREATMENTS_FULL[s])
    ...
    <>
        ...
        <div className="container">
          ...
          <div className="tp-hero-grid">
            ...
            <div className="tp-hero-visual">
              ...
              <div className={`tp-img-main ${concernImg(c.id)}`}>
      ...
      <section className="tp-section">
        <div className="container">
          <div className="tp-section-head">
            ...
            <p>Common ways this concern shows up. Your dermatologist will confirm the picture in your consultation.</p>
          </div>
      ...
      <section className="tp-section">
        <div className="container">
          <div className="tp-section-head">
            ...
            <p>
              Each is performed personally by an MD dermatologist and calibrated for your skin.
            </p>
          </div>
      ...
      <section className="tp-cta">
        <div className="container">
          ...
          <h2>Talk to an MD dermatologist about your {c.name.toLowerCase()}.</h2>
          <p>
            A one-on-one consultation, a written plan, and honest guidance, that&apos;s how every appointment begins.
          </p>
          <BookButton>Book a consultation</BookButton>
...
/** Map a concern id → one of the design's gradient variants for the hero image. */
